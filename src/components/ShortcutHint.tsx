...
//   • Refined hover state — border brightens from `var(--border-strong)` to cyan
//     60% opacity, background lifts to `var(--bg-elevated)`, the glyph warms to
...
//     focus-visible:ring-offset-2 focus-visible:ring-offset-[#f8fafc]`).
        ...
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              ...
              'hover:border-emerald-500/60 hover:bg-[var(--bg-elevated)] hover:text-emerald-300',
          ...
          >
            ...
            <span
              aria-hidden="true"
              className={cn(
                'absolute inset-0 rounded-full border border-emerald-500/40',
            ...
            <span
              aria-hidden="true"
              className={cn(
                'absolute inset-0 rounded-full bg-emerald-500/10 blur-md',
